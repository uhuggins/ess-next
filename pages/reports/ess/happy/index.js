...
function Happy({ topics, data }) { {/*Props Passed By GetIntiailProps API*/}
  return (
    <Layout topics={topics}> {/*Pass The Topics List for Side Menu*/}
      <Head>
        <title>Happy</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <OverheadTitle /> {/*Pass The Headings of The Page for Above Navigation Bar*/}
